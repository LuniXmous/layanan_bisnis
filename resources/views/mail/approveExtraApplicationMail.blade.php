...
<body>
    ...
    <p>
        {{$extraApplication->type == "dana" ? "permintaan pencairan dana":""}}
        {{$extraApplication->type == "operasional" ? "permintaan pencairan dana operasional":""}}
        {{$extraApplication->type == "kegiatan" ? "pengajuan pemberitahuan kegiatan selesai dilaksanakan":""}}
        anda telah diterima, dengan detail :
    </p>
    <table>
        <tr>
            <td>Judul</td>
